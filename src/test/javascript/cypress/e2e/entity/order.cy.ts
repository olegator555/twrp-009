...
describe('Order e2e test', () => {
  ...
  const orderSample = { name: 'Плащ Афганистан скачивание' };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="name"]`).type('Меховой convergence seize').should('have.value', 'Меховой convergence seize');

      cy.get(`[data-cy="date"]`).type('2024-01-15T09:06').blur().should('have.value', '2024-01-15T09:06');
